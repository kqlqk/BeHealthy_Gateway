...
import me.kqlqk.behealthy.gateway.dto.user_condition_service.AddDailyAteFoodDTO;
...
public class DailyAteFoodRestController {
    ...
    @CheckUserId
    @PostMapping("/food")
    public ResponseEntity<?> addDailyAteFoods(@PathVariable long id, @RequestBody AddDailyAteFoodDTO addDailyAteFoodDTO) {
